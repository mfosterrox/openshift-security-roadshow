...
* Forensic collection completes the ACME incident arc: detect (earlier RHACS labs), contain (xref:06-acs-network-and-runtime.adoc[06 Network and Runtime]), preserve (this exercise).
