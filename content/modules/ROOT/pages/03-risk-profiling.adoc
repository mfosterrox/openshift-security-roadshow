...
NOTE: The configuration details are automatically pulled by RHACS from OpenShift and Kubernetes distributions, risk score is applied to each factor, making the risk report immediately available as soon as you start running RHACS.
