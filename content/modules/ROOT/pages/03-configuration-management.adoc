...
image::03-rm-1.png[link=self, window=blank, width=100%]
...
image::03-rm-2.png[link=self, window=blank, width=100%]
...
image::03-rm-3.png[link=self, window=blank, width=100%]

[start=3]
. Next, try filtering by "Secret Type".

image::03-rm-4.png[link=self, window=blank, width=100%]
...
image::03-rm-5.png[link=self, window=blank, width=100%]
