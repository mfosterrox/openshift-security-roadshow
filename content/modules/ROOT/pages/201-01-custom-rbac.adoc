...
== Your Mission
Stop using `edit`/`admin` as the default developer badge. Cut a Role that can only touch ConfigMaps and Secrets, then prove pods, RoleBindings, and Secret delete stay denied.
