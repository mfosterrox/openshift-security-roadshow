...
This lab covers secrets management from the https://github.com/validatedpatterns/layered-zero-trust[Layered Zero Trust Validated Pattern]—Vault as the secrets store with optional External Secrets Operator (ESO) for native Kubernetes `Secret` sync.
