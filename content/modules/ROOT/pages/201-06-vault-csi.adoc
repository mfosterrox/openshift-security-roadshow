...
[source,sh]
----
oc new-project 201-06-v-secrets
----
...
[source,sh]
----
oc apply -n 201-06-v-secrets -f - <<'EOF'
...
[source,sh]
----
oc logs app -n 201-06-v-secrets --tail=5
----
...
[source,sh]
----
oc get secret db-password-sync -n 201-06-v-secrets -o jsonpath='{.data.password}' | base64 -d
----
...
[source,sh]
----
oc delete project 201-06-v-secrets --wait=false
----
