...
[start=3]
. Delete the two locally managed policies by clicking the 3 dots and selecting `Delete policy`

image::05-acm-08.png[link=self, window=blank, width=100%]
...
image::06-cd-01.png[link=self, window=blank, width=100%]
image::06-cd-02.png[link=self, window=blank, width=100%]
...
image::06-cd-03.png[link=self, window=blank, width=100%]

image::06-cd-04.png[link=self, window=blank, width=100%]
...
image::06-cd-05.png[link=self, window=blank, width=100%]
...
image::06-cd-06.png[link=self, window=blank, width=100%]
...
image::06-cd-09.png[link=self, window=blank, width=100%]
