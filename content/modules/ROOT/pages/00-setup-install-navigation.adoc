...
image::01-quay-login.png[link=self, window=blank, width=100%]
...
image::01-quay-success.png[link=self, window=blank, width=100%]
...
=== Deploy you're newly built application
...
====
This commands set's new variables for the skupper example and clones the manifests
====
