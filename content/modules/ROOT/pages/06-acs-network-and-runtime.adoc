...
Confirm the event in *Violations* (policy name, deployment, runtime stage, enforcement). UBI package-manager enforce is xref:301-04-runtime-threat-detection.adoc[301-04]; Splunk+ACS IR is xref:301-05-incident-response-forensics.adoc[301-05].
