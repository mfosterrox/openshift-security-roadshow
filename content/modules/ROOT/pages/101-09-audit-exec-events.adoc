...
Deeper correlation in Splunk (SIEM + ClusterLogForwarder) with RHACS is xref:201-06-audit-monitoring-correlation.adoc[201-06]. Compliance Operator scans are xref:101-10-security-compliance-addons.adoc[101-10].
...
|indexed store (HEC, `sourcetype=kube:apiserver:audit`)
