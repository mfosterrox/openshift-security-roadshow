...
NOTE: The pod should land in `CrashLoopBackOff/Error` with a rising restart count—the cluster refused to run this image with the privileges it assumed on a laptop.
====
