...
*If the operator pods are Running*, skip the OperatorHub install and sensor restart below and continue with *Execute Your First Compliance Scan* (or review the existing daily schedule named `acs-catch-all` under *Compliance → Schedules*).
